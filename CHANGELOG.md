...
* Add translation key for "Recent Posts" used in home page `project.html`. [#316](https://github.com/mmistakes/minimal-mistakes/pull/316)
...
* Simplified Liquid in `post-project.html` to better handle year listings [#166](https://github.com/mmistakes/minimal-mistakes/pull/166)
